    ...
    <body>
        ...
        <section id="image-section">
            <div class="image-container left" style="color: #6b0024;">
                <img src="/assets/images/homepg.png" alt="Left Image">
            ...
            <div class="image-container right">
                <img src="/assets/images/mkhome.png" alt="Right Image">
            </div>
        </section>
        ...
        <!-- Video Section -->
        <section id="video-section" class="text-container cute-font" style="background-image: url('/assets/images/pattern.jpg'); ">
            ...
            <div class="video-container" style="display: flex; justify-content: center; align-items: center;">
                <div class="box" style="width: 50%; max-width: 400px;">
                    <video id="mingkai-video" controls style="width: 100%; height: auto;">
                        <source src="/assets/videos/mingkai_edit.mp4" type="video/mp4">
